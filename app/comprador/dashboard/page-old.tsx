...
function CompradorDashboard() {
  ...
  const loadEstablishments = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        // Aceitar tanto data.estabelecimentos quanto data direto
  ...
  const loadProducts = async (estabelecimento?: string) => {
    ...
    try {
      ...
      console.log('🛍️ Carregando produtos de:', url)
      ...
      if (response.ok) {
        ...
        // Aceitar tanto data.produtos quanto data direto
  ...
  const addToCart = async (product: Product) => {
    try {
      console.log('🛒 Adicionando ao carrinho:', product.nome)
            ...
            <div className="mb-6">
              ...
              <div className="text-center py-12">
                ...
                <p className="text-gray-600 mb-4">
                  Parece que não temos estabelecimentos disponíveis no momento.
                </p>
                <Button 
